...
import { IconGauge, IconUsers, IconCurrencyDollar, IconBuildingFactory, IconDimensions, IconSpeedboat } from "@tabler/icons-react";
import { Link } from "react-router-dom";
import { Vehicle } from "../types";

const VehicleDetailCard = ({ data }: { data: Vehicle }) => {
